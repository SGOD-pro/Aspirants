...
const CourseSection: React.FC<CourseSectionProps> = ({ title, data, fadeInVariants }) => {
                                ...
                                <Card className="overflow-hidden">
                                    <CardContent className="aspect-square p-6 flex flex-col justify-between relative overflow-hidden">
                                        ...
                                        <div className="relative h-full">
                                            <div className="h-[40%] grid place-content-center mix-blend-difference text-center">
                                                <h2 className="text-4xl mb-2 font-bold">
                                                    {title === "School" ? "Class:- " : "Name:- "}
