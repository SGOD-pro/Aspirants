			...
			<div className="grid grid-cols-1 lg:grid-cols-2 justify-center items-center mb-12">
				...
				<div className="text-center lg:text-left mt-6 lg:mt-0 ">
					...
					<h2 className="text-4xl mb-3 font-semibold">
						I am <strong className="text-theme highlight">ARNAB,</strong> your{" "}
						<span className="text-theme highlight">instructor</span>
					</h2>
					<p className="text-slate-500 w-full p-3 sm:p-0 sm:max-w-md m-auto lg:m-0 lg:max-w-lg leading-tight">
						Welcome to my institution! I am here to guide you on an exciting
						journey of learning and growth. With years of experience and a
						passion for teaching, I am committed to helping you achieve your
